    ...
    appStatistics = new Vue({
        ...
        data: {
            ...
            C : {
              Col1 : {
                text : '최초',
                c : function(d){return d.UnivServiceId.IN(408408)},
              ...
              Col2 : {
                text : '추가',
                c : function(d){return d.UnivServiceId.IN(408409)},
                result : function(data){
                  return data.Count('ExamNo');
                }
              },
            ...
            R : {
                Row1 : {
                  ...
                  c : function(d){
                    ...
                    return d.UnivServiceId.IN(408408,408409)
                  },
                  GetKey : function(){return "EnterAmount"}
                },
                Row2 : {
                  cell2 : {text : '수업료', rowspan : 2},        
                  text : '공학, 자연과학, 예체능',
                  amount : '3,195,000원',
                  c : function(d){
                    return d.UnivServiceId.IN(408408,408409) && d.CollegeCode != '2'
                  },
                ...
                Row4 : {
                  ...
                  amount : '2,427,000원',
                  c : function(d){
                    return d.UnivServiceId.IN(408408,408409) && d.CollegeCode == '3'
                  },
                  GetKey : function(){return "Tuition"}
                },
                Row5 : {     
                ...
                RowAdd : {
                  ...
                  amount : '14,000원',
                  c : function(d){
                    return d.UnivServiceId.IN(408408,408409) && d.AddAmount > 0
                  },
