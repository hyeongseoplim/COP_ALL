...
{
    public partial class _4084_RegistMajorStat : System.Web.UI.Page
    {
        ...
        public static string GetStatistics()
        {
            ...
            using (DataSet ds = SqlHelper.ExecuteDataset(Common4084.CONN, CommandType.StoredProcedure, "dbo.PIMS_STATISTICS_4084_MAJORSTATREPORT", parameters))
            {
