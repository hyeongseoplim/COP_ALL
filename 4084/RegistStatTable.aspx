<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistStatTable.aspx.cs" Inherits="Jinhak.SRSAdmin_4084._4084_RegistStatTable" %>
<!DOCTYPE html>
<html>
<head>
    <title>서일대</title>
...
<body>
    ...
    <div id="Stat" style="text-align:left;margin-bottom:200px;">
        ...
        <div v-show="!Loading" style='display:none;' v-for='(RName, UnivServiceId) in GetRecruitTime'>
            ...
            <h2 style="text-align:center;">{{GetTitle}} 등록자 납부 현황표 ({{(UnivServiceId == 408407 || UnivServiceId == 408409) ? RName + " 추가" : RName}})</h2>
            ...
            <tr v-for="major in majorList">
                ...
                <td class="Cnt">{{GetPersonnel(UnivServiceId, major.MajorCode, scode) - GetPayCnt(UnivServiceId, major.MajorCode, scode) | digit}}</td>
                </template>
                ...
                <td class="Cnt">{{GetPersonnel(UnivServiceId, major.MajorCode, s) - GetPayCnt(UnivServiceId, major.MajorCode, s) | digit}}</td>
                ...
                <td class="Cnt">{{GetPersonnel(UnivServiceId, major.MajorCode) - GetPayCnt(UnivServiceId, major.MajorCode) | digit}}</td>
            ...
            <tr class="success">
                ...
                <th class="Cnt">{{GetPersonnel(UnivServiceId, majorList, scode) - GetPayCnt(UnivServiceId, majorList, scode) | digit}}</th>
                ...
                <th class="Cnt">{{GetPersonnel(UnivServiceId, majorList, s) - GetPayCnt(UnivServiceId, majorList, s) | digit}}</th>
                ...
                <th class="Cnt">{{GetPersonnel(UnivServiceId, majorList) - GetPayCnt(UnivServiceId, majorList) | digit}}</th>
            ...
            <tr class="info">
                ...
                <th class="Cnt">{{GetPersonnel(UnivServiceId, undefined, scode) - GetPayCnt(UnivServiceId, undefined, scode) | digit}}</th>
                ...
                <th class="Cnt">{{GetPersonnel(UnivServiceId, undefined, s) - GetPayCnt(UnivServiceId, undefined, s) | digit}}</th>
                ...
                <th class="Cnt">{{GetPersonnel(UnivServiceId) - GetPayCnt(UnivServiceId) | digit}}</th>
...
<script type="text/javascript" src="js/RegistStatTable.js"></script>
</body>
</html>