<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StatReportV5.aspx.cs" Inherits="Jinhak.SRSAdmin_4084._4084_StatReportV5" %>
<!DOCTYPE html>
<html>
<head>
    <title>서일대</title>
...
<body>
    <div id="Stat" style="text-align:left;margin-bottom:200px;">
        ...
        <div v-show="!Loading" style='display:none;margin-bottom:10px;'>
            <h2 style="text-align:center;">{{GetTitle}} 회계별 입금현황 (편입학)</h2>
            ...
            <div v-for='(tbl, tk, idx) in T' v-if="!tbl.hide">
                ...
                <thead>
                <tr class="active">
                    <th style='text-align:center;' rowspan='2' colspan='5'>회계별</th>
	...
	<script type="text/javascript" src="js/StatReportV5.js?t=<%=DateTime.Now.Ticks.ToString()%>"></script>
</body>
</html>