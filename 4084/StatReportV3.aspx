<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StatReportV3.aspx.cs" Inherits="Jinhak.SRSAdmin_4084._4084_StatReportV3" %>
<!DOCTYPE html>
<html>
<head>
    <title>서일대</title>
...
<body>
    <div id="Stat" style="text-align:left;margin-bottom:200px;">
        ...
        <div v-show="!Loading" style='display:none;margin-bottom:10px;'>
            <h2 style="text-align:center;">{{GetTitle}} 회계별 입금현황 (전공심화)</h2>
	...
	<script type="text/javascript" src="js/StatReportV3.js?t=<%=DateTime.Now.Ticks.ToString()%>"></script>
</body>
</html>