<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StatReportV2.aspx.cs" Inherits="Jinhak.SRSAdmin_4084._4084_StatReportV2" %>
<!DOCTYPE html>
<html>
<head>
    <title>서일대</title>
...
<body>
    <div id="Stat" style="text-align:left;margin-bottom:200px;">
        ...
        <div v-show="!Loading" style='display:none;margin-bottom:10px;'>
            ...
            <div v-for='(tbl, tk, idx) in T' v-if="!tbl.hide">
                ...
                <tr class="active">
                    ...
                    <th style='text-align:center;' colspan='5'>{{tbl.text}}내역(인원)</th>
                ...
                <tr v-for='row in R' v-if="!row.hide">
                    ...
                    <!--<td v-for='col in C' class='Cnt'>{{GetResult(tbl, row, col)  | digit}}</td>-->
                    <td v-for='col in C' class='Cnt'>
                ...
                <tr>
                    ...
                    <td v-for='col in C' class='Cnt'>{{GetResult(tbl, R.RowAdd, col)  | digit}}</td>
                </tr>
                </tbody>
                <tfoot>
                <tr class="active">
        ...
        <div v-show="!Loading" style='display:none;'>
            ...
            <tr>
                <th>예치금</th>
                <td class='Cnt'>{{GetResult(T.TBL3, R.RowPre, C.ColTotal) - GetResult(T.TBL4, R.RowPre, C.ColTotal) | digit}}</td>
                <td class='Cnt'>{{0 | digit}}</td>
                <td class='Cnt'>{{GetResult(T.TBL3, R.RowPre, C.ColSum) - GetResult(T.TBL4, R.RowPre, C.ColSum) | digit}}</td>

                <td class='Cnt'>{{GetResult(T.TBL1, R.RowPre, C.ColTotal) | digit}}</td>
                <td class='Cnt'>{{0 | digit}}</td>
                <td class='Cnt'>{{GetResult(T.TBL1, R.RowPre, C.ColSum) | digit}}</td>

                <td class='Cnt'>{{GetResult(T.TBL2, R.RowPre, C.ColTotal) | digit}}</td>
                <td class='Cnt'>{{0 | digit}}</td>
                <td class='Cnt'>{{GetResult(T.TBL2, R.RowPre, C.ColSum) | digit}}</td>

                <td class='Cnt'>{{((GetResult(T.TBL3, R.RowPre, C.ColTotal) - GetResult(T.TBL4, R.RowPre, C.ColTotal)) + GetResult(T.TBL1, R.RowPre, C.ColTotal) - GetResult(T.TBL2, R.RowPre, C.ColTotal)) | digit}}</td>
                <td class='Cnt'>{{0 | digit}}</td>
                <td class='Cnt'>{{GetResult(T.TBL3, R.RowPre, C.ColSum) - GetResult(T.TBL4, R.RowPre, C.ColSum) + GetResult(T.TBL1, R.RowPre, C.ColSum) - GetResult(T.TBL2, R.RowPre, C.ColSum) | digit}}</td>
            </tr>
            <tr>
                <th>입학</th>
                <td class='Cnt'>{{GetResult(T.TBL3, R.RowEnter, C.ColTotal) - GetResult(T.TBL4, R.RowEnter, C.ColTotal) | digit}}</td>
                <td class='Cnt'>{{0 | digit}}</td>
                <td class='Cnt'>{{(GetResult(T.TBL3, R.RowEnter, C.ColSum) + GetResult(T.TBL3, R.RowEnterScholarShip, C.ColSum)) - (GetResult(T.TBL4, R.RowEnter, C.ColSum) + GetResult(T.TBL4, R.RowEnterScholarShip, C.ColSum)) | digit}}</td>
                ...
                <td class='Cnt'>{{
                    ...
                    GetResult(T.TBL1, R.RowEnterScholarShip, C.ColSum) - GetResult(T.TBL2, R.RowEnterScholarShip, C.ColSum)  | digit}}</td>
            </tr>
            <tr>
                <th>수업료</th>
                <td class='Cnt'>{{GetResult(T.TBL3, R.RowTuition, C.ColTotal) - GetResult(T.TBL4, R.RowTuition, C.ColTotal) | digit}}</td>
                <td class='Cnt'>{{0 | digit}}</td>
                <td class='Cnt'>{{(GetResult(T.TBL3, R.RowTuition, C.ColSum) + GetResult(T.TBL3, R.RowTuitionScholarShip, C.ColSum)) - (GetResult(T.TBL4, R.RowTuition, C.ColSum)  + GetResult(T.TBL4, R.RowTuitionScholarShip, C.ColSum)) | digit}}</td>
                ...
                <td class='Cnt'>{{
                    ...
                    GetResult(T.TBL1, R.RowTuitionScholarShip, C.ColSum) - GetResult(T.TBL2, R.RowTuitionScholarShip, C.ColSum) | digit}}</td>
            </tr>
            <tr>
                <th>학생경비</th>
            ...
            <tr class="active">
                <th>합계</th>
                <!-- <th class='Cnt' colspan='3'>{{GetResult(T.TBL3, R.RowPre, C.ColSum)  - GetResult(T.TBL4, R.RowPre, C.ColSum) | digit}}</th>
                <th class='Cnt' colspan='3'>{{GetResult(T.TBL1, R.RowPre, C.ColSum) | digit}}</th>
                <th class='Cnt' colspan='3'>{{GetResult(T.TBL2, R.RowPre, C.ColSum) | digit}}</th>
                <th class='Cnt' colspan='3'>{{GetResult(T.TBL3, R.RowPre, C.ColSum) - GetResult(T.TBL4, R.RowPre, C.ColSum) + GetResult(T.TBL1, R.RowPre, C.ColSum) - GetResult(T.TBL2, R.RowPre, C.ColSum) | digit}}</th> -->
                ...
                <th class='Cnt' colspan='3'>
                    {{
                        ...
                        GetResult(T.TBL1, R.RowAdd, C.ColSum) +     
                ...
                <th class='Cnt' colspan='3'>
                    {{
                        ...
                        GetResult(T.TBL2, R.RowAdd, C.ColSum) +     
	...
	<script type="text/javascript" src="js/StatReportV2.js?t=<%=DateTime.Now.Ticks.ToString()%>"></script>
</body>
</html>